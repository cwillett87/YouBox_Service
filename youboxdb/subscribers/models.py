...
class User(AbstractUser):
    ...
    REQUIRED_FIELDS = ['username', 'first_name', 'last_name', 'role', 'street_Address', 'city', 'state', 'zip_Code', 'phone']
...
class Utoken(models.Model):
    user_Id = models.ForeignKey('subscribers.User', null=False, on_delete=models.CASCADE)


class Clothing(models.Model):
    image_Id = models.ForeignKey('subscribers.Image', null=False, on_delete=models.CASCADE)
    user_Id = models.ForeignKey('subscribers.User', null=False, on_delete=models.CASCADE)
    city = models.CharField(max_length=100)
...
class Subscription(models.Model):
    ...
    number_Items = models.IntegerField(null=False, on_delete=models.CASCADE)
